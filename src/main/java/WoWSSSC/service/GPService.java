                        ...
                        if (tempList != null && tempList.size() > 0 && cField.getName().equals(field.getName()))
                        {
                            ...
                            if (field.getName().equalsIgnoreCase("Artillery"))
                            {
                                ...
                                if (shipComponents.getArtillery() == null)
                                {
                                    ...
                                    {
                                        String tempRealName = (String) global.get(serverParam).get("IDS_" + value.getName().toUpperCase());
                                        if (StringUtils.isNotEmpty(tempRealName)) {
                                            value.setRealName(tempRealName);
