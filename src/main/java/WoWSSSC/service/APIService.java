...
//
//                }
//                if (coef.getAircraft_passive_defence_coef() != 0)
//                {
//
//                }
//                if (coef.getAmmo_detonation_chance_coef() != 0)
//                {
//
//                }
//                if (coef.getAnti_aircraft_defence_coef() != 0)
//                {
...
//                    }
//                }
//                if (coef.getBurn_chance_big_coef() != 0)
//                {
...
//                    }
//                }
//                if (coef.getBurn_chance_small_coef() != 0)
//                {
//                    String[] splitName = ship.getArtillery().getSlots().get("0").getName().split("mm");
//                    int caliber = Integer.parseInt(splitName[0].trim());
//
...
//                    }
//                }
//                if (coef.getBurning_time_coef() != 0)
//                {
...
//
//                }
//                if (coef.getDetect_distance_by_plane_coef() != 0)
//                {
//
//                }
//                if (coef.getDetect_distance_coef() != 0)
//                {
//
//                }
//                if (coef.getDistance_coef() != 0)
//                {
...
//
//                }
//                if (coef.getFlood_chance_coef() != 0)
//                {
//
//                }
//                if (coef.getFlooding_time_coef() != 0)
//                {
//                    ship.setFlood(ship.getFlood() * coef.getFlooding_time_coef());
//                }
//                if (coef.getHealth_regeneration_speed() != 0)
//                {
//
//                }
//                if (coef.getMax_speed_coef() != 0)
//                {
//
//                }
//                if (coef.getRam_damage_caused_coef() != 0)
//                {
//
//                }
//                if (coef.getRam_damage_received_coef() != 0)
//                {
//
//                }
//                if (coef.getReload_time_coef() != 0)
//                {
//                    if (ship.getAtbas() != null)
//                    {
        ...
        if (upgrades != null)
        {
            upgrades.forEach(upgrade -> {
                if (!upgrade.equals(""))
                {
                    ...
                    if (temp.getProfile().getVisibilityDistCoeff() != null)
                    {
                        if (ship.getConcealment() != null)
                        {
                            ship.getConcealment().setDetect_distance_by_ship(ship.getConcealment().getDetect_distance_by_ship() * (float) temp.getProfile().getVisibilityDistCoeff().getValue());
                        }
                    }
...
//                            {
//                                ship.getAtbas().getSlots().entrySet().forEach(entry -> entry.getValue().setShot_delayWithoutDefault(entry.getValue().getShot_delay() * tempProfile.getAtba().getReload_time_coef()));
//                            }
//                        }
//                    }
