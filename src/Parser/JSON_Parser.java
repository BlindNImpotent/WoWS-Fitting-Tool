...
public class JSON_Parser 
{
	...
	private List<JSONObject> Japan_ARPJSONList = new ArrayList<>();
	...
	private void setShipsJSONAndName()
	{
		...
		Japan_ARPJSONList.sort((o1, o2) -> ((String) o1.get("name")).compareTo((String) o2.get("name")));
		...
		Japan_ARPJSONList.sort((o1, o2) -> (Long.valueOf((long) o1.get("tier")).compareTo((long) o2.get("tier"))));
		...
		Japan_ARPJSONList.forEach((Japan_ARP -> Japan_ARPNameList.add((String) Japan_ARP.get("name"))));
